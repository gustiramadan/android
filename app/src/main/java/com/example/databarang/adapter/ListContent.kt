...
class ListContent(val data : List<DataItem?>?, val context: Context) :
    Adapter<ListContent.Viewfolder>() {
    class Viewfolder(val view: View) : ViewHolder1(view){
        ...
        val ediBarang = view.findViewById<TextView>(R.id.tv_edit)
    ...
    override fun onBindViewHolder(holder: Viewfolder, position: Int) {
        ...
        holder.ediBarang.setOnClickListener {
        ...
        holder.deleteBarang.setOnClickListener {
            AlertDialog.Builder(context)
                ...
                .setPositiveButton("Ya", DialogInterface.OnClickListener { dialog, which ->
                    koneksi.service.deleteBarang(model?.id)
